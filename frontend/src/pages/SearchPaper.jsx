  ...
  useEffect(() => {
    const fetchHistory = async () => {
      ...
      try {
        ...
        console.error("Failed to fetch paper history:", e);
      } finally {
        ...
        {isSearching ? (
          ...
          <div className="page-loading">
            <div className="empty-results-card glass">
              ...
              <p className="empty-results-desc">Try another research topic.</p>
            </div>
          </div>
        ) : (
          <div>
            {history.length > 0 ? (
              <div style={{ marginTop: '2rem' }}>
                <div className="results-header-row">
                  <h2 className="results-title">Your Recent Workspaces</h2>
                </div>
                <div className="cards-grid">
                  {history.map((paper) => (
                    <PaperCard
              ...
              <div className="page-loading">
                <div className="empty-results-card glass">
                  <h3 className="empty-results-title">Search for papers</h3>
                  <p className="empty-results-desc">Enter a research topic to find papers.</p>
                </div>
              </div>
            )}
          </div>
